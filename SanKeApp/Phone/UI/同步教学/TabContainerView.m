...
@interface TabContainerView ()<UIScrollViewDelegate>
...
//    self.topScrollView = [[TeachingMutiTabView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, 44)];
//    self.topScrollView.tabArray = self.tabArray;
//    self.topScrollView.currentTab =  self.tabArray[self.chooseIndex];
//    [self addSubview:self.topScrollView];
//    WEAK_SELF
//    [self.topScrollView setClickTabButtonBlock:^(NSInteger currentIndex) {
//        STRONG_SELF
...
//        
//        [self scrollTitleWithIndex:currentIndex];
//        
...
//}
//
//-(void)setChildViewControllers:(NSArray<__kindof TabViewController *> *)childViewControllers {
...
////    
////    [_childViewControllers enumerateObjectsUsingBlock:^(TabViewController *obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
////        if (self.chooseIndex < _childViewControllers.count && idx == self.chooseIndex) {
