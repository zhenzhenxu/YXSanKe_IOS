...
- (void)yx_updateWithDefaultHighlightColor {
    CGFloat alpha = 0.5;
    
    UIColor *nColor = [self titleColorForState:UIControlStateNormal];
    UIColor *hColor = [nColor colorWithAlphaComponent:alpha];
    UIImage *nImage = [[self imageForState:UIControlStateNormal] yx_imageReplaceWithColor:nColor];
    UIImage *hImage = [[self imageForState:UIControlStateNormal] yx_imageReplaceWithColor:hColor];
